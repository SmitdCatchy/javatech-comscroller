...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_scene_service__ = __webpack_require__("../../../../../src/app/services/scene.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_module_service__ = __webpack_require__("../../../../../src/app/services/module.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_editor_service__ = __webpack_require__("../../../../../src/app/services/editor.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_component__ = __webpack_require__("../../../../../src/app/app.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_index_index_component__ = __webpack_require__("../../../../../src/app/pages/index/index.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_modules_modules_component__ = __webpack_require__("../../../../../src/app/pages/modules/modules.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_account_account_component__ = __webpack_require__("../../../../../src/app/pages/account/account.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_module_module_component__ = __webpack_require__("../../../../../src/app/pages/module/module.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_register_register_component__ = __webpack_require__("../../../../../src/app/pages/register/register.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_header_dropdownmenu_dropdownmenu_component__ = __webpack_require__("../../../../../src/app/components/header/dropdownmenu/dropdownmenu.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_header_navigation_navigation_component__ = __webpack_require__("../../../../../src/app/components/header/navigation/navigation.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_editor_editor_component__ = __webpack_require__("../../../../../src/app/pages/editor/editor.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__pages_modules_modules_component__["a" /* ModulesComponent */],
                __WEBPACK_IMPORTED_MODULE_12__pages_account_account_component__["a" /* AccountComponent */],
                __WEBPACK_IMPORTED_MODULE_13__pages_module_module_component__["a" /* ModuleComponent */],
                ...
                __WEBPACK_IMPORTED_MODULE_17__pages_register_register_component__["a" /* RegisterComponent */],
                __WEBPACK_IMPORTED_MODULE_18__components_header_dropdownmenu_dropdownmenu_component__["a" /* DropdownmenuComponent */],
                __WEBPACK_IMPORTED_MODULE_19__components_header_navigation_navigation_component__["a" /* NavigationComponent */],
                __WEBPACK_IMPORTED_MODULE_20__pages_editor_editor_component__["a" /* EditorComponent */],
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__services_scene_service__["a" /* SceneService */],
                __WEBPACK_IMPORTED_MODULE_7__services_module_service__["a" /* ModuleService */],
                __WEBPACK_IMPORTED_MODULE_8__services_editor_service__["a" /* EditorService */]
            ],
...
var Scene = (function () {
    function Scene(_id, _mId, _background, _objects) {
        ...
        else if (_background.trim().charAt(0) === 'h' ||
...
var EditorComponent = (function () {
    function EditorComponent(moduleService, sceneService, userService, route, router, renderer, cdr, http) {
    ...
    EditorComponent.prototype.ngOnInit = function () {
        ...
        if (this.moduleId !== 0) {
            ...
            this.moduleService.getModuleById(this.moduleId).subscribe(function (result) {
                ...
                if (_this.userService.user.id !== t.owner) {
    ...
    EditorComponent.prototype.switch = function (w) {
        ...
        if (this.folder_active)
            setTimeout(function () { _this.fillFolder(); }, 10);
        this.fileNames = [];
                ...
                if (_this.sceneId !== -1) {
                    for (var _o = 0, _p = _this.nodes; _o < _p.length; _o++) {
                        ...
                        if (node_3.id === _this.sceneId) {
                            ...
                            for (var _s = 0, _t = _this.canvasScenes; _s < _t.length; _s++) {
                                var scene = _t[_s];
                                if (scene.id === _this.sceneId) {
                                    var max = 1;
                                    for (var _u = 0, _v = scene.objects; _u < _v.length; _u++) {
                                        var obj = _v[_u];
                                        if (max < +obj.max) {
                                            max = +obj.max;
                                        }
                            ...
                            if (!update)
                                ...
                                for (var _w = 0, _x = _this.currentObjects; _w < _x.length; _w++) {
                                    var obj = _x[_w];
                                    if (obj.mask === +data[1]) {
                    ...
                    for (var _y = 0, _z = _this.canvasScenes; _y < _z.length; _y++) {
                        var scene = _z[_y];
                        if (scene.id === _this.sceneId) {
        ...
        var _loop_1 = function (scene) {
            if (scene.id === this_1.sceneId) {
                this_1.sceneService.createSceneObjectBySceneId(this_1.sceneId).subscribe(function (result) {
                    var newObj = {
                        "mask": _this.currentObjects[_this.currentObjects.length - 1].mask + 1,
                        "maskAction": "none",
                        "obj": {
                            "id": result.objectId,
                            "sId": _this.sceneId,
                    ...
                    for (var i = 0; i < scene.objects.length;) {
                        scene.objects[i].mask = ++i;
                    }
                    _this.currentObjects.push(newObj);
                    for (var i = 0; i < _this.currentObjects.length;) {
                        _this.currentObjects[i].mask = ++i;
                    }
                    _this.objectId = _this.currentObjects[_this.currentObjects.length - 1].obj.id;
                    _this.maskId = _this.currentObjects[_this.currentObjects.length - 1].mask;
                    _this.currentObject = _this.currentObjects[_this.currentObjects.length - 1];
                });
            }
        };
        var this_1 = this;
    ...
    EditorComponent.prototype.fillFolder = function () {
        var _this = this;
        this.userService.getFiles().subscribe(function (result) {
            _this.folder = result.files.sort(function (a, b) {
    ...
    EditorComponent.prototype.selectName = function (name) {
        var f = -1;
    ...
    EditorComponent.prototype.isSelectedFile = function (name) {
        for (var _i = 0, _a = this.fileNames; _i < _a.length; _i++) {
            var f = _a[_i];
            if (f === name)
                return true;
        }
    ...
    EditorComponent.prototype.deleteFile = function () {
        var _this = this;
        if (this.fileNames.length > 0) {
            var promises = [];
            for (var _i = 0, _a = this.fileNames; _i < _a.length; _i++) {
                var fileName = _a[_i];
                var promise = this.userService.deleteFile(fileName);
                promises.push(promise);
            }
            __WEBPACK_IMPORTED_MODULE_7_rxjs_Observable__["a" /* Observable */].forkJoin(promises).subscribe(function (result) {
                _this.fileNames = [];
                _this.ngOnInit();
            });
        }
    };
    EditorComponent.prototype.getFileUrl = function (file) {
        return "url('../../../../media/" + this.userService.user.id + "/" + file + "')";
    };
    EditorComponent.prototype.handleFileInput = function (files) {
        this.fileNames = [];
    ...
    EditorComponent.prototype.uploadFiles = function () {
        ...
        if (this.filesToUpload !== null) {
            this.selectedFiles = true;
            this.uploading = true;
            this.userService.uploadFiles(this.filesToUpload).subscribe(function (data) {
                setTimeout(function () {
                    _this.userService.getFiles().subscribe(function (result) {
                        _this.folder = result.files.sort(function (a, b) {
                            if (a.firstname < b.firstname)
                                return -1;
                            if (a.firstname > b.firstname)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_module_service__ = __webpack_require__("../../../../../src/app/services/module.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_user_service__ = __webpack_require__("../../../../../src/app/services/user.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_editor_service__ = __webpack_require__("../../../../../src/app/services/editor.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_Module__ = __webpack_require__("../../../../../src/app/models/Module.ts");
...
var ModulesComponent = (function () {
    function ModulesComponent(moduleService, userService, editorService, route, router) {
        this.moduleService = moduleService;
        this.userService = userService;
    ...
    ModulesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_module_service__["a" /* ModuleService */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__services_editor_service__["a" /* EditorService */],
...
module.exports = "<div id=\"play\" [style.min-height.px]=\"container_min_height\">\n  <div id=\"stage\"\n    [ngStyle]=\"{\n      'position' : fullscreen ? 'absolute' : '',\n      'top' : fullscreen ? '50%' : '',\n      'left' : fullscreen ? '50%' : '',\n      'transform' : fullscreen ? 'translate(-50%, -50%)' : '',\n      'z-index' : fullscreen ? '9001' : '',\n      'width' : fullscreen ? fsw + 'px' : '',\n      'height' : fullscreen ? fsh + 'px' : '',\n      'opacity' : fullscreenOnce ? resizeCorrection() : ''}\"\n  >\n    <div id=\"even\" class=\" scene {{animEven}}\" [ngStyle]=\"evenScene.getStyle()\">\n      <div *ngFor =\"let obj of evenScene.objects\"\n      [ngClass]=\"activeEvenEvent(obj)\"\n      (click)=\"handleSceneClicks(obj.action)\"\n      [ngStyle]=\"obj.getStyle(stageW, stageH)\"\n      >\n        <p *ngIf=\"obj.type === 'txt'\">{{obj.cont}}</p>\n      </div>\n      <div id=\"ep\" class=\"{{getEvenPerm()}}\"></div>\n    </div>\n\n    <div id=\"odd\" class=\" scene {{animOdd}}\" [ngStyle]=\"oddScene.getStyle()\">\n      <div *ngFor =\"let obj of oddScene.objects\"\n      [ngClass]=\"activeOddEvent(obj)\"\n      (click)=\"handleSceneClicks(obj.action)\"\n      [ngStyle]=\"obj.getStyle(stageW, stageH)\"\n      >\n        <p *ngIf=\"obj.type === 'txt'\">{{obj.cont}}</p>\n      </div>\n      <div id=\"op\" class=\"{{getOddPerm()}}\"></div>\n    </div>\n  </div>\n</div>\n\n<div id=\"preload\" style=\"display:none;position:absolute;left:0;top:0;\">\n  <img  style=\"width:50px;height:50px; overflow:none;\" class=\"toPreload\"\n    *ngFor =\"let preload of preloads\" src=\"{{preload}}\">\n</div>\n"
...
var PlayComponent = (function () {
    function PlayComponent(moduleService, sceneService, userService, route, cdr, router) {
        this.moduleService = moduleService;
        this.sceneService = sceneService;
        this.userService = userService;
        this.route = route;
        ...
        this.sceneService.getSceneById(sceneId).subscribe(function (result) {
            _this.sceneService.getObjectsBySceneId(sceneId).subscribe(function (res) {
                ...
                if (_this.switch) {
                    ...
                    _this.oddPrev = 1;
                    _this.initial = true;
                    _this.preloadImages(_this.oddScene);
                }
                else {
                    ...
                    _this.evenPrev = 1;
                    _this.initial = true;
                    _this.preloadImages(_this.evenScene);
                }
            });
        });
    };
    PlayComponent.prototype.preloadImages = function (current) {
        var _this = this;
        this.preloads = [];
        var scenes = [];
        for (var _i = 0, _a = current.toPreload; _i < _a.length; _i++) {
            var id = _a[_i];
            var promise = this.sceneService.getSceneById(id);
            scenes.push(promise);
        }
        __WEBPACK_IMPORTED_MODULE_7_rxjs_Observable__["a" /* Observable */].forkJoin(scenes).subscribe(function (res) {
            var results = res;
            var objects = [];
            for (var _i = 0, results_1 = results; _i < results_1.length; _i++) {
                var scene = results_1[_i];
                var preScene = new __WEBPACK_IMPORTED_MODULE_5__models_Scene__["a" /* Scene */](scene.scene.id, scene.scene.mId, scene.scene.background, [new __WEBPACK_IMPORTED_MODULE_5__models_Scene__["b" /* SceneObject */](0, 0, 'err', 'none', 0, 0, 0, 0, 0, '', '', '0')]);
                var bg = preScene.background;
                if (bg !== '' && bg.charAt(0) !== '#' && bg.charAt(0) !== 'r') {
                    _this.preloads.push(bg);
                }
                var promise = _this.sceneService.getObjectsBySceneId(scene.scene.id);
                objects.push(promise);
            }
            __WEBPACK_IMPORTED_MODULE_7_rxjs_Observable__["a" /* Observable */].forkJoin(objects).subscribe(function (res2) {
                var results2 = res2;
                for (var _i = 0, results2_1 = results2; _i < results2_1.length; _i++) {
                    var objects_1 = results2_1[_i];
                    for (var _a = 0, _b = objects_1.objects; _a < _b.length; _a++) {
                        var obj = _b[_a];
                        var pl = new __WEBPACK_IMPORTED_MODULE_5__models_Scene__["b" /* SceneObject */](obj.id, obj.sId, obj.type, obj.action, obj.x, obj.y, obj.w, obj.h, obj.z, obj.cont, obj.style, obj.event).imageToPreload;
                        if (pl !== '' && pl.charAt(0) !== '#' && pl.charAt(0) !== 'r') {
                            _this.preloads.push(pl);
                        }
                    }
                }
            });
    ...
    PlayComponent.prototype.getOddPerm = function () {
        return this.oddPerm;
    };
    PlayComponent.prototype.getEvenPerm = function () {
    ...
    // }
    PlayComponent.prototype.activeOddEvent = function (obj) {
    ...
    PlayComponent.prototype.activeEvenEvent = function (obj) {
        var events = obj.getEvents();
        var init = "deactive";
        var curr = false;
        var prev = false;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__module_service__ = __webpack_require__("../../../../../src/app/services/module.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scene_service__ = __webpack_require__("../../../../../src/app/services/scene.service.ts");
...
var EditorService = (function () {
    function EditorService(moduleService, sceneService, userService, route, router, http) {
        this.moduleService = moduleService;
        this.sceneService = sceneService;
        this.userService = userService;
        this.route = route;
    ...
    EditorService.prototype.setAll = function () {
    };
    EditorService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__module_service__["a" /* ModuleService */],
            __WEBPACK_IMPORTED_MODULE_2__scene_service__["a" /* SceneService */],
...
var UserService = (function () {
    function UserService(http, route) {
        ...
        this.users = [
            {
                'data': new __WEBPACK_IMPORTED_MODULE_3__models_User__["a" /* User */](1, "admin", "Master", "ADMIN", []),
                'pass': 'admin'
            },
            {
                'data': new __WEBPACK_IMPORTED_MODULE_3__models_User__["a" /* User */](2, "norbertbang", "Opti", "USER", []),
                'pass': 'admin'
            },
            {
                'data': new __WEBPACK_IMPORTED_MODULE_3__models_User__["a" /* User */](3, "nandi", "Nándor Úr", "USER", []),
                'pass': 'nandi'
            },
            {
                'data': new __WEBPACK_IMPORTED_MODULE_3__models_User__["a" /* User */](4, "szofia", "Szofia", "USER", []),
                'pass': 'admin'
            },
            {
                'data': new __WEBPACK_IMPORTED_MODULE_3__models_User__["a" /* User */](5, "dudu", "Dudu", "USER", []),
                'pass': 'dudu'
            },
            {
                'data': new __WEBPACK_IMPORTED_MODULE_3__models_User__["a" /* User */](6, "uhul", "Uhul", "USER", []),
                'pass': 'uhul'
            },
            {
                'data': new __WEBPACK_IMPORTED_MODULE_3__models_User__["a" /* User */](7, "bence", "Bence", "USER", []),
                'pass': 'bence'
            },
            {
                'data': new __WEBPACK_IMPORTED_MODULE_3__models_User__["a" /* User */](8, "catchy", "Catchy", "USER", []),
                'pass': 'admin'
            }
        ];
        this.user = new __WEBPACK_IMPORTED_MODULE_3__models_User__["a" /* User */](-1, "error", "Guest", "GUEST", []);
    ...
    UserService.prototype.register = function (name, nick, email, pass) {
        ...
        var newUser = new __WEBPACK_IMPORTED_MODULE_3__models_User__["a" /* User */](this.users.length, name, nick, "USER", []);
        this.users.push({ 'data': newUser, 'pass': pass });
        this.user = newUser;
        return "";
    };
    // FOLDER
    UserService.prototype.uploadFiles = function (files) {
        var formData = new FormData();
        formData.append('id', '' + this.user.id);
        for (var i = 0; i < files.length; i++) {
            formData.append('file', files.item(i), files.item(i).name);
        }
        return this.http.post(__WEBPACK_IMPORTED_MODULE_5__utils_ServerRoutes__["b" /* Server */].routeTo(__WEBPACK_IMPORTED_MODULE_5__utils_ServerRoutes__["a" /* Routes */].FILE_UPLOAD), formData)
            .map(function (res) { return res.json(); });
    };
    UserService.prototype.getFiles = function () {
        return this.http.get(__WEBPACK_IMPORTED_MODULE_5__utils_ServerRoutes__["b" /* Server */].routeTo(__WEBPACK_IMPORTED_MODULE_5__utils_ServerRoutes__["a" /* Routes */].FILE_LIST) + this.user.id)
            .map(function (res) { return res.json(); });
    };
    UserService.prototype.deleteFile = function (file) {
        return this.http.delete(__WEBPACK_IMPORTED_MODULE_5__utils_ServerRoutes__["b" /* Server */].routeTo(__WEBPACK_IMPORTED_MODULE_5__utils_ServerRoutes__["a" /* Routes */].FILE_DELETE) + this.user.id + '/' + file)
            .map(function (res) { return res.json(); });
    };
    UserService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_4__angular_router__["a" /* ActivatedRoute */]])
    ], UserService);
    return UserService;
}());
...
var Routes = (function () {
    ...
    Routes.FILE_LIST = 'file/list/';
    Routes.FILE_UPLOAD = 'file/upload';
    Routes.FILE_DELETE = 'file/delete/';
    return Routes;
}());
